            ...
            <div class="accordion" id="accordionExample">
                ...
                >
                  <div class="accordion-body">
                    <p>
                      ...
                      when ordering a software application. You don't want to
                      spend many months developing it with us without being sure
                      what you need
                    </p>
                  </div>
                </div>
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="headingTwo">
                  ...
                  >
                    <span>Should I create a mobile or a web app ?</span>
                  </button>
                </h2>
                <div
                  id="collapseTwo"
                ...
                >
                  <div class="accordion-body">
                    <p>
                      ...
                      collecting, monetization capabilities than web
                      applications. Progressive Web Apps are a good compromise
                      between a mobile and web app. But remember that sooner or
                      later you may need both mobile and web app and when that
                ...
                >
                  <div class="accordion-body">
                    <p>
                      ...
                      or phone. We'll meet and talk it over. Just be sure to
                      prepare as much info about your idea as possible, it will
                      smoothen the meeting and benefit further cooperation
                    </p>
                  </div>
                </div>
              </div>
                ...
                >
                  <div class="accordion-body">
                    <p>
                      ...
                      you get what you are paying for. What happens after you
                      finish my app? Hopefully the app is exactly what you
                      dreamed of :) But apart from delivering a finished
                      product, we are happy to provide you with technical
                      support and app maintenance should you need it. After all,
                      we know our work inside out. Of course if you want to
                      maintain the app by yourself the source code and all
                      technical data is at your disposal, but even in that case,
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="heading">
                  ...
                  >
                    <span>
                      I want to be involved in the app development process, do
                      you have a problem with that?</span
                    >
                  </button>
                </h2>
                <div
              ...
              <div class="accordion-item">
                ...
                >
                  <div class="accordion-body">
                    <p>
                      To give you a precise answer we must prepare a project
                      scope and create a budget. We shall tell you how much of
                      that scope can be completed within the budget and we'll be
                      able to estimate how long will it take after at least a
                      month of work. Don't worry, if you're not happy with our
